...
\COPY (SELECT message_id, channel_id, int_user_id, content FROM messages WHERE deleted_at IS NULL AND guild_id = 181866934353133570) TO 'raw/messages.csv' DELIMITER ',' CSV HEADER;
